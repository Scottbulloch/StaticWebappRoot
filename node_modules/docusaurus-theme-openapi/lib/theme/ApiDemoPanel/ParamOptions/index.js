...
function ParamArrayFormItem({
  ...
  return <>
      ...
      <button className={_stylesModule.default.buttonThin} onClick={handleAddItem} disabled={(param === null || param === void 0 ? void 0 : (_param$schema7 = param.schema) === null || _param$schema7 === void 0 ? void 0 : _param$schema7.maxItems) != null && items.length >= param.schema.maxItems}>
        Add item
      </button>
    </>;
}
