...
function setPathParams(postman, queryParams) {
  const recursiveEncodeURIComponent = c => Array.isArray(c) ? c.map(encodeURIComponent) : encodeURIComponent(c);
    ...
    case "urlencoded":
      {
        ...
        (_clonedPostman$body$u2 = clonedPostman.body.urlencoded) === null || _clonedPostman$body$u2 === void 0 ? void 0 : _clonedPostman$body$u2.assimilate(params, false); // Now let's append the array keys
